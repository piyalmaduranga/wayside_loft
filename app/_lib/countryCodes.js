export const countryCodes = [
  ...
  { code: "GB", dial: "+44", name: "United Kingdom", min: 10, max: 10, regex: /^[0-9]{10}$/, example: "7911 123456" },
  { code: "AU", dial: "+61", name: "Australia", min: 9, max: 9, regex: /^[0-9]{9}$/, example: "412 345 678" },
  { code: "DE", dial: "+49", name: "Germany", min: 10, max: 11, regex: /^[0-9]{10,11}$/, example: "170 1234567" },
  { code: "FR", dial: "+33", name: "France", min: 9, max: 9, regex: /^[0-9]{9}$/, example: "6 12 34 56 78" },
  { code: "IN", dial: "+91", name: "India", min: 10, max: 10, regex: /^[0-9]{10}$/, example: "98765 43210" },
  { code: "CA", dial: "+1", name: "Canada", min: 10, max: 10, regex: /^[0-9]{10}$/, example: "416 555 0199" },
  { code: "RU", dial: "+7", name: "Russia", min: 10, max: 10, regex: /^[0-9]{10}$/, example: "912 345 6789" },
  { code: "CN", dial: "+86", name: "China", min: 11, max: 11, regex: /^[0-9]{11}$/, example: "139 1234 5678" },
  { code: "JP", dial: "+81", name: "Japan", min: 10, max: 10, regex: /^[0-9]{10}$/, example: "90 1234 5678" },
  { code: "AE", dial: "+971", name: "United Arab Emirates", min: 9, max: 9, regex: /^[0-9]{9}$/, example: "50 123 4567" },
  { code: "SA", dial: "+966", name: "Saudi Arabia", min: 9, max: 9, regex: /^[0-9]{9}$/, example: "50 123 4567" },
  { code: "MV", dial: "+960", name: "Maldives", min: 7, max: 7, regex: /^[0-9]{7}$/, example: "779 1234" },
  { code: "SG", dial: "+65", name: "Singapore", min: 8, max: 8, regex: /^[0-9]{8}$/, example: "8123 4567" },
  { code: "IT", dial: "+39", name: "Italy", min: 10, max: 10, regex: /^[0-9]{10}$/, example: "312 345 6789" },
  { code: "ES", dial: "+34", name: "Spain", min: 9, max: 9, regex: /^[0-9]{9}$/, example: "612 345 678" },
  { code: "NL", dial: "+31", name: "Netherlands", min: 9, max: 9, regex: /^[0-9]{9}$/, example: "6 12345678" },
  { code: "CH", dial: "+41", name: "Switzerland", min: 9, max: 9, regex: /^[0-9]{9}$/, example: "79 123 45 67" },
  { code: "SE", dial: "+46", name: "Sweden", min: 9, max: 9, regex: /^[0-9]{9}$/, example: "70 123 45 67" },
  { code: "NO", dial: "+47", name: "Norway", min: 8, max: 8, regex: /^[0-9]{8}$/, example: "912 34 567" },
  { code: "DK", dial: "+45", name: "Denmark", min: 8, max: 8, regex: /^[0-9]{8}$/, example: "12 34 56 78" },
  { code: "NZ", dial: "+64", name: "New Zealand", min: 8, max: 10, regex: /^[0-9]{8,10}$/, example: "21 123 4567" },
  { code: "ZA", dial: "+27", name: "South Africa", min: 9, max: 9, regex: /^[0-9]{9}$/, example: "82 123 4567" },
  { code: "BR", dial: "+55", name: "Brazil", min: 10, max: 11, regex: /^[0-9]{10,11}$/, example: "11 91234-5678" },
  ...
  { code: "VA", dial: "+39-06", name: "Vatican City" },
