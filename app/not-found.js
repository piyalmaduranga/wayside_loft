...
export default function NotFound() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4 py-16 bg-[#F8F6F1] text-[#1A1815]">
      <span className="font-serif font-bold text-7xl text-[#C4A87A] mb-4">404</span>
      <h2 className="font-serif text-2xl md:text-3xl font-medium mb-3">Oops! Page Not Found</h2>
